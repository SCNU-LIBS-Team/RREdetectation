...
SVG_PATH = OUT_DIR / "温度迭代流程_优化版_v3.svg"
...
svg.append(text_block(inner_x + inner_w / 2, inner_y + 143, "每轮根据当前温度 T 更新谱线库；未收敛时返回更新步骤", size=34, weight=450, fill=MUTED, stroke_width=8))
svg.append(label(inner_x + inner_w - 70, inner_y + 178, "实验参数：max_iterations = 12，tolerance = 1e−5", size=30, anchor="end", weight=520))
